...
本文档完整记录本次在 `D:\isaac-sim` 环境中，将

- `D:\isaac-sim\zzcurobo\curobo_for_windows`
...
- 操作系统：Windows 11
- Isaac Sim 根目录：`D:\isaac-sim`
- cuRobo 项目目录：`D:\isaac-sim\zzcurobo\curobo_for_windows`
...
- `D:\isaac-sim\logs\gui_full_stdout_20260404_152640.log`
...
- `D:\isaac-sim\zzcurobo\curobo_for_windows\setup.py`
...
- `torch` 走 `D:\isaac-sim\python_packages`
...
- `torch`：`D:\isaac-sim\python_packages\torch`
- `numpy`：`D:\isaac-sim\kit\python\lib\site-packages\numpy`
- `PIL`：`D:\isaac-sim\extscache\omni.kit.pip_archive-...\pip_prebundle\PIL`
...
- `D:\isaac-sim\zzcurobo\curobo_for_windows\src\curobo\util\torch_utils.py`
...
- `D:\isaac-sim\zzcurobo\curobo_for_windows\src\curobo\util\sample_lib.py`
...
- `D:\isaac-sim\zzcurobo\curobo_for_windows\src\curobo\rollout\cost\bound_cost.py`
...
- `D:\isaac-sim\zzcurobo\curobo_for_windows\src\curobo\rollout\dynamics_model\kinematic_model.py`
...
- `D:\isaac-sim\zzcurobo\curobo_for_windows\examples\isaac_sim\gui_motion_gen_smoke.py`
...
### `D:\isaac-sim\zzcurobo\curobo_for_windows\install_in_isaacsim.bat`
...
- 使用 `D:\isaac-sim\python_packages` 作为 torch overlay
- 使用 `--no-deps`
...
### `D:\isaac-sim\zzcurobo\curobo_for_windows\src\curobo\curobolib\__init__.py`
...
### `D:\isaac-sim\zzcurobo\curobo_for_windows\examples\isaac_sim\smoke_test_headless.py`
...
### `D:\isaac-sim\zzcurobo\curobo_for_windows\run_gui_smoke_capture.ps1`
...
- 新增共享模块：
  - `D:\isaac-sim\zzcurobo\curobo_for_windows\examples\isaac_sim\motion_gen_compat.py`
- 在这个模块里统一封装三类逻辑：
...
- `D:\isaac-sim\zzcurobo\curobo_for_windows\examples\isaac_sim\motion_gen_reacher.py`
  - 正式迁入同样的规划兼容逻辑
...
- `D:\isaac-sim\zzcurobo\curobo_for_windows\examples\isaac_sim\simple_stacking.py`
  - 也接入同一套 `plan_single_with_compat(...)`
  - 避免堆叠流程仍停留在旧的失败判定
- `D:\isaac-sim\zzcurobo\curobo_for_windows\run_isaacsim_curobo_demo.bat`
...
在 `D:\isaac-sim\zzcurobo\curobo_for_windows` 下执行：
...
```powershell
powershell -ExecutionPolicy Bypass -File D:\isaac-sim\zzcurobo\curobo_for_windows\run_gui_smoke_capture.ps1
```

运行结束后查看：

- `D:\isaac-sim\logs\gui_full_latest_paths.txt`
...
```bat
set CUROBO_DEMO_SCRIPT=D:\isaac-sim\zzcurobo\curobo_for_windows\examples\isaac_sim\gui_motion_gen_smoke.py
D:\isaac-sim\zzcurobo\curobo_for_windows\run_isaacsim_curobo_demo.bat
```
...
```powershell
$args = '/k set CUROBO_GUI_SMOKE_AUTO_QUIT=0 && cd /d D:\isaac-sim && call D:\isaac-sim\isaac-sim.bat --exec D:\isaac-sim\zzcurobo\curobo_for_windows\examples\isaac_sim\gui_motion_gen_smoke.py'
