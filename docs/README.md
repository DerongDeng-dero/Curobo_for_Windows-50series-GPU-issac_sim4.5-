...
- [English docs set](./en_version)
- [Chinese docs set](./zh-cn_version)

## Recommended Reading Paths

Beginner installation:

1. [Windows + Isaac Sim 4.5+ full tutorial](./en_version/WINDOWS_ISAACSIM_CUROBO_INSTALL_TUTORIAL.en.md)
2. [Installable version manual](./en_version/INSTALLABLE_VERSION_MANUAL.en.md)
3. [Reading order and overview](./en_version/DOCS_READING_ORDER_AND_OVERVIEW.en.md)

GUI in-app usage:

1. [Selector + in-app cuRobo beginner guide](./en_version/ISAACSIM_SELECTOR_IN_APP_CUROBO_BEGINNER_GUIDE.en.md)
...
1. [Reading order and overview](./en_version/DOCS_READING_ORDER_AND_OVERVIEW.en.md)
2. [Windows + Isaac Sim 4.5+ full tutorial](./en_version/WINDOWS_ISAACSIM_CUROBO_INSTALL_TUTORIAL.en.md)
3. [Installable version manual](./en_version/INSTALLABLE_VERSION_MANUAL.en.md)
...
- [Chinese docs hub](./README.zh-CN.md)
- [Chinese reading order and overview](./zh-cn_version/DOCS_READING_ORDER_AND_OVERVIEW.zh-CN.md)
- [Chinese install tutorial](./zh-cn_version/WINDOWS_ISAACSIM_CUROBO_INSTALL_TUTORIAL.zh-CN.md)
