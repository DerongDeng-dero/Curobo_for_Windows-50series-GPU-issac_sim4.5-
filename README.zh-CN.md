...
[![GPU](https://img.shields.io/badge/GPU-NVIDIA%20RTX%2050--Series-16a34a?style=flat-square)](./docs/README.zh-CN.md)
[![Platform](https://img.shields.io/badge/Platform-Windows-0078D4?style=flat-square)](./docs/README.zh-CN.md)
[![Isaac Sim](https://img.shields.io/badge/Isaac%20Sim-4.5%2B-76B900?style=flat-square)](./docs/README.zh-CN.md)

# cuRobo for Windows + NVIDIA RTX 50 系显卡 + Isaac Sim 4.5+

*面向 Windows、NVIDIA RTX 50 系新显卡与 Isaac Sim 4.5+ 工作流整理的 cuRobo 仓库*

这个仓库保留了上游 cuRobo 的主体代码，同时补齐了一套更适合下面这类组合的实际使用路径：

- Windows
- NVIDIA GeForce RTX 50 系显卡
- Isaac Sim 4.5 及以上版本

这里的安装脚本、修复流程、Python 包装、示例入口和文档体系，都是围绕这套目标环境整理和维护的。
...
- 主要面向英伟达 RTX 50 系这类新显卡
- 主要面向 Isaac Sim 4.5 及以上版本

如果你正好属于这两类目标用户，这个仓库里的安装路径、兼容逻辑和文档路线就是为你整理的。
...
cuRobo 是一个 CUDA 加速的机器人算法库，目标是在并行计算下，把常见机器人运动学、碰撞检测和轨迹优化做得更快。当前主要包括：
...
cuRobo 会并行评估多组 seed 轨迹来寻找可行解，并通过对 jerk 和 acceleration 进行惩罚得到更平滑、更短的轨迹。
